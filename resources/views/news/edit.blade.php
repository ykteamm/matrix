        ...
        <div class="card-body">
            <form method="post" action="{{ route('updateNews', ['id' => $nw->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input name="publish" type="checkbox" class="form-check" @if($nw->publish) checked @endif>
                </div>
                <div class="form-group w-100">
                    ...
                    <div class="w-100 w-lg-100 mt-1">
                        <textarea id="sceditor" name="desc"  style="height:600px;width:100.5%;">{{ $nw->desc }}</textarea>
                    </div>
                </div>
                <div class="mt-4">
