        ...
        <div class="container-fluid" style="margin-top: 5%;">
          <div class="card-body">
            ...
            <ul class="nav nav-tabs">
              <li class="ms-auto" style="margin-right: 4rem">
                ...
                {{-- <div class="btn-group" id="dropdownNotClosingOne">
                  ...
                  <div class="dropdown-menu dropdown-menu-left">
                    ...
                    <div>
                    <button style="margin-left: 5rem" class="btn btn-rounded btn-outline-primary btn-sm" type="button" id="get_check" onclick="checkFunctionOne()">Submit</button>
                    </div>
                  </div>
                </div> --}}
              </li>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="card bg-white">
                 <div class="card-body">
                  <div id="death_one_id"></div>
                  <div id="death_one"></div>
                 </div>
              </div>
           </div>
            <div class="col-md-6">
