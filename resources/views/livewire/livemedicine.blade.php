        ...
        <div class="card-body">
            ...
            <div class="dash-contetnt">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <a href="{{route('rm-medicine',['region' => 'all','time' => 'today'])}}" style="padding: 0px 6px;display:none;" type="button" class="btn btn-outline-danger arrow-up-medicine-live"><i class="fas fa-eye" aria-hidden="true"></i></a>
