    ...
    <div class="pointer" style="margin-top:110px;">
        <div class="container mt-5">
            ...
            <div class="my-3 text-end" style="text-align: end">
                <a class="btn btn-primary" href="{{ route('createInfos') }}">
                    Malumot qo'shish
                </a>
            </div>
            {{--  --}}
            @include('infos.showInfo')
            {{--  --}}
            @foreach ($infos as $info)
                <div class="card border border-left-primary">
                    <div class="p-4 d-flex align-items-center justify-content-between"
                        ...
                        <a onclick="showInfo({{ $info->id }})" data-toggle="modal" data-target="#showInfoItem">
                            <div style="font-size:18px;font-weight:600;overflow:hidden" class="pr-3">
                                {{ $info->title }}
                            </div>
                        </a>
                        <div class="modal fade" id="deleteInfos" tabindex="-1" role="dialog"
                            aria-labelledby="deleteInfosTitle" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer d-block">
                                        <form class="d-flex align-items-center justify-content-around"
                                            action="{{ route('deleteInfos', ['id' => $info->id]) }}" method="POST">
                                            @csrf
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            <a onclick="showInfo({{ $info->id }})" data-toggle="modal" data-target="#showInfoItem" class="btn btn-sm btn-success mr-2">
                            ...
                            <a href="{{ route('editInfos', ['id' => $info->id]) }}"
                            ...
                            <button class="btn btn-sm btn-danger mr-1" data-toggle="modal" data-target="#deleteInfos">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
