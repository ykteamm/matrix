          ...
          <ul>
            ...
            @isset(Session::get('per')['dash'])
             @if(Session::get('per')['dash'] == 'true')
               ...
               <li><a href="{{route('capitan',['month'=>date('Y-m')])}}"><i class="fas fa-home"></i>  <span>Capitan dashboard</span></a>
               </li>
               @elseif($rm != 1 && $cap == 2)
               <li><a href="{{route('capitan',['month'=>date('Y-m')])}}"><i class="fas fa-home"></i>  <span>Capitan dashboard</span></a>
               </li>
             ...
             @if(Session::get('per')['elchi-day'] == 'true')
                 <li><a href="{{route('elchilar',['month'=>date('Y-m')])}}"><i class="fas fa-users"></i>  <span>Elchilar kunlik</span></a>
               @endif
               @endisset
             ...
             <li class="submenu">
               <a href="settings.html"><i class="fas fa-crown"></i> <span> Shox yurish </span><span class="menu-arrow"></span></a>
               <ul style="display: none;">
                  ...
                  <li><a href="{{route('king-sold',['user_id'=>'all','region_id'=>'all','date' => 'today'])}}"><span>Hisobot </span></a>
                </ul>
            </li>
             @endif
             @endisset
             ...
             @isset(Session::get('per')['user_pharmacy'])
               @if(Session::get('per')['user_pharmacy'] == 'true')
                  <li><a href="{{route('pharmacy-user','today')}}"><i class="fas fa-clinic-medical"></i>  <span>Dorixona</span></a>
               @endif
             @endisset

             @isset(Session::get('per')['pro'])
               @if(Session::get('per')['pro'] == 'true')
                  <li><a href="{{route('pro-list',['time'=>'today','region'=>'all','pharm' => 'all'])}}"><i class="fas fa-pills"></i>  <span>Mahsulotlar </span></a>
                  </li>
               @endif
             @endisset
             ...
             @if(Session::get('per')['team'] == 'true')
               ...
               <li class="submenu">
                  <a href="settings.html"><i class="fas fa-synagogue"></i> <span> Jamoa </span><span class="menu-arrow"></span></a>
                  <ul style="display: none;">
            ...
            @isset(Session::get('per')['team'])
             @if(Session::get('per')['team'] == 'true')
            <li class="submenu">
               <a href="settings.html"><i class="fas fa-people-carry"></i>  <span> Elchi jang </span><span class="menu-arrow"></span></a>
               <ul style="display: none;">
           ...
           <li class="submenu">
              <a href="settings.html"><i class="fas fa-toolbox"></i>  <span> Toolz Bot </span><span class="menu-arrow"></span></a>
              <ul style="display: none;">
           ...
           @endisset
             ...
             @if(Session::get('per')['trend'] == 'true')
               ...
               <li class="submenu">
                  <a href="settings.html"><i class="fas fa-chart-line"></i>  <span> Trend </span><span class="menu-arrow"></span></a>
                  <ul style="display: none;">
             ...
             @endisset
                ...
                <li class="submenu">
                  ...
                  <ul style="display: none;">
                    ...
                    <li class="submenu">
                        <a href="settings.html"> <span> Mahsulot kirim/qoldiq </span><span class="menu-arrow"></span></a>
                        <ul style="display: none;">
                            @isset(Session::get('per')['accept'])
                                @if(Session::get('per')['accept'] == 'true')
            ...
            <li class="submenu">
              <a href="settings.html"><i class="fas fa-user-graduate"></i>  <span> Baholash </span><span class="menu-arrow"></span></a>
              <ul style="display: none;">
                 @isset(Session::get('per')['grade'])
                  @if(Session::get('per')['grade'] == 'true')
                  ...
                  <li class="submenu">
                     <a href="settings.html">  <span> Bilim savollar </span><span class="menu-arrow"></span></a>
                     <ul style="display: none;">
             ...
             <li><a href="{{route('setting',date('m.Y'))}}"><i class="fas fa-calendar-week"></i>  <span>Kalendar </span></a>
             </li>
             @endif
             @endisset
             ...
             <li class="submenu">
               <a href="settings.html"><i class="fas fa-hand-holding-usd"></i>  <span> Narx </span><span class="menu-arrow"></span></a>
               <ul style="display: none;">
            ...
            @endif
             ...
             @if(Session::get('per')['control'] == 'true')
               ...
               <li class="submenu">
                  <a href="settings.html"><i class="fas fa-vihara"></i>  <span> User boshqaruvi </span><span class="menu-arrow"></span></a>
                  <ul style="display: none;">
            ...
            @endif
             ...
             <li><a href="{{route('purchase.journal')}}"><i class="fas fa-history"></i>  <span>Taxrirlash tarixi </span></a>
             </li>
             @endif
             @endisset
             ...
             @if(Session::get('per')['rol'] == 'true')
                  ...
                  {{-- @if(isset(Session::get('per')['rol_create']) || isset(Session::get('per')['rol_read'])) --}}
                     <a href="settings.html"><i class="fas fa-user-shield"></i> <span> Rol System </span><span class="menu-arrow"></span></a>
                  {{-- @endisset --}}
                     <ul style="display: none;">
