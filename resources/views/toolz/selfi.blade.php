                    ...
                    @foreach ($shifts as $item)
                        ...
                        <div class="row mb-5 mt-5 pt-2 pb-2" style="border: 1px solid black; border-radius:15px;">
                            <div class="col-md-4">
                                <div class="mt-4">
                                    @if($host == 'mat')
                                    <img id="avatarImg" height="500px" class="avatar-img" src="https://jang.novatio.uz/images/users/open_smena/{{$item->open_image}}" alt="Profile Image">
                                    @else
                                ...
                                <div class="row">
                                    <div class="col-md-2 col-sm-4 col-md-2 mb-3">
                                        @if (json_decode($item->admin_check)->check == 'ok')
                                            <button type="button" class="btn btn-block btn-outline-info active">Tasdiqlangan </button>
                                        @elseif(json_decode($item->admin_check)->check == 'robe')
                                            <button type="button" class="btn btn-block btn-outline-info active">Xalati yoq</button>
                                        @elseif(json_decode($item->admin_check)->check == 'code')
                                            <button type="button" class="btn btn-block btn-outline-info active">Kun soni yoq</button>
                                        @elseif(json_decode($item->admin_check)->check == 'card')
                                            <button type="button" class="btn btn-block btn-outline-info active">Beyjik yoq yoq</button>
                                        @else
                                            <button type="button" class="btn btn-block btn-outline-info active">Lokatsiya yoq</button>
                                        @endif
                                    </div>
                                </div>
                            </div>
