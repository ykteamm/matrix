                    ...
                    <div class="card detail-box1">
                        <div class="card-body">
                            <div class="dash-contetnt">
                                <h4 class="text-white" style="text-align: center"> Shox yurish ligasi </h4>
                                <div class="row">
                                                ...
                                                <div class="dash-contetnt">
                                                    ...
                                                    @foreach ($item->liga_user as $k => $l)
                                                        ...
                                                        <h2 class="text-white">
                                                            ...
                                                            <span class="badge bg-primary">
                                                                {{$l->user->last_name}} {{$l->user->first_name}}
                                                            </span>
                                                        </h2>
                                                        @endif
                                                    @endforeach
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <button type="submit" style="width:100%;" class="btn btn-primary" data-toggle="modal" data-target="#addmember{{$item->id}}"> 
                                                                <i class="fas fa-plus"></i> 
                                                            </button>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <button type="submit" style="width:100%;" class="btn btn-danger" data-toggle="modal" data-target="#minusmember{{$item->id}}"> 
                                ...
                                <select class="form-control form-control-sm" name='user_id' required>
                                    ...
                                    @foreach ($liga->liga_user as $l)
                                        @if($l->liga_id == $liga->id)
                                                <option value='{{$l->user->id}}'>{{$l->user->last_name}} {{$l->user->first_name}}</option>                                           
                                        @endif
                                    @endforeach
                                </select>
                            </div>
