            ...
            @foreach ($videos as $video)
                <div class="card border border-left-primary">
                    <div class="p-4 d-flex align-items-center justify-content-between"
                        ...
                        <div class="modal fade" id="deleteVideos" tabindex="-1" role="dialog"
                            aria-labelledby="deleteVideosTitle" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer d-block">
                                        <form class="d-flex align-items-center justify-content-around"
                                            action="{{ route('deleteVideos', ['id' => $video->id]) }}" method="POST">
                                            @csrf
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            <a onclick="showVid({{ $video->id }})" data-toggle="modal" data-target="#showVideoItem" class="btn btn-sm btn-success mr-2">
                            ...
                            <button class="btn btn-sm btn-danger mr-1" data-toggle="modal" data-target="#deleteVideos">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
