...
@section('admin_content')
    <div class="container" style="margin-top: 50px">
        ...
        <div class="card-body">
            <form method="post" action="{{ route('updateVideos', ['id' => $video->id]) }}" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    <label for="newsTitle">
                        Sarlavha
                    </label>
                    <input name="title" value="{{ $video->title }}" class="form-control form-control-sm" type="text">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input name="publish" type="checkbox" class="form-check" @if($video->publish) checked @endif>
                </div>
                <div class="form-group">
                    <label for="publish">Video URL</label>
                    <input name="url" type="text" class="form-control form-control-sm" value="{{ $video->url }}">
                </div>
                <div class="form-group w-100">
                    ...
                    <div class="w-100 w-lg-100 mt-1">
                        <textarea id="sceditor" name="desc"  style="height:300px;width:100.5%;">{{ $video->desc }}</textarea>
                    </div>
                </div>
                <div class="mt-4">
