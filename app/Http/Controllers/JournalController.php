...
class JournalController extends Controller
{
    public function purchase()
    {
        ...
        select('tg_productssold.order_id','tg_purchase_journals.created_at','tg_purchase_journals.id','tg_purchase_journals.old','tg_purchase_journals.new','tg_medicine.name','tg_user.first_name','tg_user.last_name','tg_user.username')
