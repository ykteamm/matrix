...
class MegaTurnirController extends Controller
{
    ...
    public function teamBattle()
    {
        ...
        $id1 = MegaTurnirTeamBattle::where('tour',2)->pluck('user1id')->toArray();
        $id2 = MegaTurnirTeamBattle::where('tour',2)->pluck('user2id')->toArray();
    ...
    public function teamBattleSave(Request $request)
    {
        ...
        $teach->begin = '2023-10-16';
        $teach->end = '2023-10-18';
        $teach->tour = 2;
        $teach->save();
    ...
    public function userBattle()
    {
        ...
        $id1 = MegaTurnirUserBattle::where('tour',2)->pluck('user1id')->toArray();
        $id2 = MegaTurnirUserBattle::where('tour',2)->pluck('user2id')->toArray();
